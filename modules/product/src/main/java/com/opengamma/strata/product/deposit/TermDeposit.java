 ...
 * 定期存款。
 * <p>
 * 定期存款是一种金融工具，为某一特定期限的金额提供固定利率。
 * 例如，以1%的利率投资1000英镑3个月。
 * <p>
 * 定期存款有两个付款日期，一个在开始日期，一个在结束日期。
 * 例如，投资1000英镑3个月意味着向交易对手支付1000英镑的首期付款和向交易对手支付1000英镑的最终付款以及利息。
 */
@BeanDefinition
public final class TermDeposit
     ...
     * 定期存款是“买入”还是“卖出”。
     * <p>
     * “买入”的价值意味着在开始日期支付本金，在结束日期收到本金加上利息。“卖出”的价值意味着相反。
     * 换言之，“买”是指以收取利息为目的，购买“存钱”服务。
     */
     ...
     * 本金金额
     * <p>
     * 代表本金金额，必须为非负数。本金金额的货币单位由{@code currency}指定。
     */
     ...
     * 定期存款的开始日期。
     * <p>
     * 利息从此日期开始累积。此日期通常设置为有效的工作日。
     * 或者，可以设置{@code businessDayAdjustment}其中的属性来调整规则。
     */
    @PropertyDefinition(validate = "notNull")
    ...
    /**
     * 要应用于开始日期和结束日期的工作日调整，可选属性。
     * <p>
     * 开始日期和结束日期通常定义为有效工作日，因此不需要调整。
     * 如果存在此可选属性，则将根据此处的定义调整开始和结束日期。
     */
