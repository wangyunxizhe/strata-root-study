 ...
 * 标准日计数约定的常量和实现。
 * <p>
 * 每项约定的目的是定义如何将日期转换为数字年份分数。在计算一段时间内的应计利息时使用。
 */
public final class DayCounts {
    // 常量是通过枚举查找间接得到的，以允许用配置替换它们。
    ...
    /**
     * “30/360 ISDA”日计数：30天/月，一年360天
     * <p>
     * 计算结果为{@code (360 * deltaYear + 30 * deltaMonth + deltaDay) / 360}。
     * 计算逻辑参考StandardDayCounts.THIRTY_360_ISDA
     * <p>
